...
const router = (app) => {
  ...
  app.get('/getContests', mid.requiresLogin, mid.requiresValidated, controllers.Competition.getContests);
  ...
  app.get('/accountInfo', mid.requiresLogin, mid.requiresValidated, controllers.Account.accountPage);
  ...
  app.get('/makeContest', mid.requiresLogin, mid.requiresValidated, controllers.Competition.makePage);
  app.post('/makeEntry', mid.requiresLogin, mid.requiresValidated, controllers.Entry.make);
  app.get('/entries', mid.requiresLogin, mid.requiresValidated, controllers.Entry.getEntriesByContest);
